...
- **Model:** semantic reasoning LLM. Post-MVP target is Claude 3.5 Sonnet via AWS Bedrock; MVP may use a smaller open model with the same rubric.
...
- **Failure behavior:** if blocked, the author receives a reason and can revise.
